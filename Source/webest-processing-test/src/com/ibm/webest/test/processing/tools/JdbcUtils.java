...
public final class JdbcUtils {
	...
	public static void executeScript(String name) throws FileNotFoundException, SQLException, ClassNotFoundException {
		Connection connection = getJdbcConnection();
		JdbcScriptRunner scriptRunner = new JdbcScriptRunner(connection);
		scriptRunner.runScript(new FileReader(JdbcUtils.class.getResource(name).getFile()));
		connection.commit();
	}
